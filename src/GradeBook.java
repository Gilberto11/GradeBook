...
public class GradeBook {
	...
	private String courseName;//course name for this GradeBook represents
	//int instance variables are initialized to 0 by default 
	
	private int total;//sum of grades
	private int gradeCounter;//number of grade entered
	...
	}//end of the method setCourseName
	
	//method to retrieve the course name
	public String getCourseName()
	{
		return courseName;
	}//end the method courseName
	...
	public void displayGradeReport(){
		...
		if (gradeCounter !=0){
			...
			System.out.printf( "Totalof the %d grades entered is %d\n", gradeCounter, total );
